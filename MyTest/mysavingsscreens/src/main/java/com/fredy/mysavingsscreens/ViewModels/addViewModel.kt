...
import com.fredy.mysavingsscreens.Data.User.Account
...
import com.fredy.mysavingsscreens.Data.User.Category
import com.fredy.mysavings.Data.Records.RecordItem
...
class addViewModel(
    ...
    var newItem by mutableStateOf(RecordItem())
